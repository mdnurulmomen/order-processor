...
<head>
  ...
  @if (Auth::guard('merchant')->check()) 
    <meta name="merchant-id" content="{{ Auth::guard('merchant')->user()->id }}" />
  @endif
  
  <title>Qupaid | Merchant</title>
          ...
          <ul class="navbar-nav ml-auto mt-1">
            ...
            <li class="nav-item dropdown user-menu float-right">
              <a href="#" class="nav-link" data-toggle="dropdown" aria-expanded="false">
                ...
                <img src="{{ asset(\Auth::guard('merchant')->user()->profile_picture ?? 'designToBeChangedHere') }}" class="user-image profile-user-img img-fluid" alt="User Image">
                
              </a>
              <ul class="ml-auto dropdown-menu">
                <!-- User image -->
                <li class="user-header bg-success">
                  <img src="{{ asset(\Auth::guard('merchant')->user()->profile_picture ?? 'designToBeChangedHere') }}" class="img-circle" alt="User Image">

                  <p>
                    {{ \Auth::guard('merchant')->user()->user_name }}
