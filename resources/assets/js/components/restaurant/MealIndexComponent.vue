								...
								<table class="table table-hover table-bordered table-striped text-center">
									...
									<tbody>
									  	...
									  	>
								    		...
								    		<td>{{ restaurantMeal.meal.name}}</td>
									  	</tr>
									  	<tr v-show="!mealsToShow.length">
								    		<td colspan="6">
	...
	export default {
		...
		methods : {
			...
			fetchRestaurantAllMeals(){
				this.loading = true;
				axios
					.get('/api/restaurant-meals/' + this.restaurant_id + '/' + this.perPage +'?page='+ this.pagination.current_page)
					.then(response => {
		    ...
		    searchData() {
				...
				axios
				.get(
					"/api/restaurant-meals/" + this.restaurant_id + '/' + this.query +"/" + this.perPage +
				    "?page=" +
