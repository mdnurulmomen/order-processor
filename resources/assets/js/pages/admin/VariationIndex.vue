								...
								<table class="table table-hover table-bordered table-striped text-center">
									...
									<tbody>
									  	...
									  	>
								    		...
								    		<td>{{ variation.name | capitalize }}</td>
								    		<td>
	...
	export default {
		...
		methods : {
    		...
    		storeVariation(){
				...
				axios
					.post('/variations/'+ this.perPage, this.singleVariationData.variation)
					.then(response => {
			...
			updateVariation(){
				...
				axios
					.put('/variations/' + this.singleVariationData.variation.id + '/' + this.perPage, this.singleVariationData.variation)
					.then(response => {
			...
			destroyVariation(){
				...
				axios
					.delete('/variations/' + this.singleVariationData.variation.id+ '/' + this.perPage)
					.then(response => {
						if (response.status == 200) {
			...
			restoreVariation(){
				...
				axios
					.patch('/variations/' + this.singleVariationData.variation.id + '/' + this.perPage)
					.then(response => {
						if (response.status == 200) {
		    ...
		    searchData() {
				...
				axios
				.get(
					"/api/variations/search/"+ this.query +"/" + this.perPage +
				    "?page=" +
