									  	...
									  	>  		
								  			<td colspan="8">
										    	...
										    	<table class="table">
										    		...
										    		<tbody>
												    	<tr v-show="merchantProductCategory.products.length" 
													    	v-for="(product, index) in merchantProductCategory.products" 
													    	:key="product.id"
													  	>
													    	<td scope="row">
													    		{{ index + 1 }}
	...
	export default {
		...
		methods : {
			...
			updateMerchantProductStock(merchantProduct){
				...
				this.currentMerchantProduct.item_stock = merchantProduct.item_stock;
